    ...
    function ($, bs) {
        ...
        require(
            [
                ...
                rbundle('ivoryckeditor/ckeditor'),
                rbundle('sonataformatter/vendor/markitup-markitup/markitup/jquery.markitup'),
                rbundle('sonataformatter/markitup/sets/markdown/set'),
                rbundle('sonataformatter/markitup/sets/html/set'),
                rbundle('sonataformatter/markitup/sets/textile/set')
            ],
            function (fields) {
