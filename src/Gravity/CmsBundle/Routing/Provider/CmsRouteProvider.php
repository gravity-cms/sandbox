...
namespace Gravity\CmsBundle\Routing\Provider;
...
/**
 * Class CmsRouteProvider
 *
 * @package Gravity\CmsBundle\Routing\Provider
 * @author  Andy Thorne <contrabandvr@gmail.com>
 */
class CmsRouteProvider implements RouteProviderInterface
{
    /**
     * @var EntityManager
     */
    ...
    function __construct(EntityManager $entityManager)
    {
        ...
        $this->routeRepository = $entityManager->getRepository('GravityCmsBundle:Route');
    }
    ...
    public function getRouteCollectionForRequest(Request $request)
    {
        ...
        /** @var \Gravity\CmsBundle\Entity\Route[] $routes */
